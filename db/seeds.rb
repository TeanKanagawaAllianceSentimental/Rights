...
# SaleShipping.create(organisation_name: "にんにん株式会社", shipping_postal_code: "222-2222", shipping_address1: "東京都千代田区二重橋2-2", shipping_address2: "", department: "営業部", contact_person: "二階堂　二郎", member_id: 2)
...
# SaleInvoice.create(bill_to: "にんにん株式会社", billing_postal_code: 3333333, billing_address1: "三重県三重市三重3-3-3", billing_address2: "サンコーポ303", contact_person: "三鷹　三助", department: "自宅警備", member_id: 2)
